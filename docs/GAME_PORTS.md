...
| 6 | Quarto! | 抽象棋类 | [上游源码](https://github.com/obono/ArduboyWorks/tree/master/quarto) | A/B | 未导入、未构建；可覆盖棋盘绘制、AI 和文本，需从多游戏仓库固定子目录 |
...
| 11 | Knight Move | 棋盘动作谜题 | [上游源码](https://github.com/obono/ArduboyWorks) | B | 未导入、未构建；动作和棋盘逻辑兼具，需从多游戏仓库定位独立入口 |
| 12 | Glove | 迷宫动作冒险 | [上游源码](https://github.com/ArduboyCollection/glove) | B | 未导入、未构建；官方精选，适合综合验证 Sprites、碰撞和 EEPROM |
| 13 | Hopper | 立体跳跃动作 | [上游源码](https://github.com/ArduboyCollection/ArduboyWorks/tree/master/hopper) | B/C | 未导入、未构建；官方精选且玩家评价高，需先核对声音库和同仓库构建结构 |
