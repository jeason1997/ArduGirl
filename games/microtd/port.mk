...
TERMINAL_MICROTD_SOURCES := $(filter-out platform/linux/src/render.cpp platform/linux/src/storage.cpp,\
	$(MICROTD_SOURCES:platform/linux/src/sdl.cpp=platform/linux/src/terminal.cpp))
...
ifneq ($(filter microtd microtd-terminal $(MICROTD_TARGET) $(TERMINAL_MICROTD_TARGET),$(MAKECMDGOALS) $(GAME)),)
PORT_DEPENDS_OVERRIDE := $(MICROTD_OBJECTS:.o=.d) $(TERMINAL_MICROTD_OBJECTS:.o=.d)
endif
endif
