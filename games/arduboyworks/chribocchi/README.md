...
一款以太空场景为背景的街机动作游戏。源码来自固定 revision 的 ArduboyWorks 集合，上游子模块保持未修改。

## 截图验收

| 启动 Logo | 标题或菜单 | 核心玩法 |
| --- | --- | --- |
| ![Chri Bocchi 启动 Logo](assets/title.png) | ![Chri Bocchi 标题或菜单](assets/menu.png) | ![Chri Bocchi 太空动作关卡](assets/gameplay.png) |
